...
export function FileUploadIcon({ className }: IconProps) {
  return (
...
export function ScaleIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.9} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v18M7 21h10M12 5 5 8m7-3 7 3" />
      <path d="M2 12 5 8l3 4a3 3 0 0 1-6 0ZM16 12l3-4 3 4a3 3 0 0 1-6 0Z" />
    </svg>
  )
}
...
export function PaperclipIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <path d="m21.4 11.05-8.9 8.9a5.5 5.5 0 0 1-7.8-7.8l8.9-8.9a3.7 3.7 0 0 1 5.2 5.2l-8.9 8.9a1.9 1.9 0 0 1-2.7-2.7l8.2-8.2" />
    </svg>
  )
}
